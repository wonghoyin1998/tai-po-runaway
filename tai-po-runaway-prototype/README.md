...
- Hunter：查看存活名單、GPS 目標，並回報捉到某位參加者
- 工作人員：管理活動、發布訊息、處理 Hunter 捉人回報、管理參加者、Hunter、籌碼、GPS、一番賞、二人影相、復活及事件紀錄
- 匯出紀錄：CSV 下載或複製文字紀錄
...
- Hunter 捉人會先建立 `catchReports` 待工作人員處理，並發布回報訊息給所有參加者
- 工作人員確認捉人後，才更新 `participant.status = "dead"`，並增加 Hunter `caughtCount`
- 工作人員可用總控頁「發布訊息給所有參加者」，參加者頁會即時顯示
- 工作人員復活會更新參加者狀態並清走復活申請
- 一番賞會先扣 1 籌碼，再處理結果，最後標記 `hasPlayedIchiban = true`
