...
- 任務時段：按活動分鐘自動開放，也可由總控手動開關
- 參加者：查看倒數、任務、狀態、籌碼、一番賞、二人影相、GPS，並可回報被捉及申請復活
- Hunter：查看存活名單、GPS 目標、確認捉人和安全提醒
- 工作人員：管理參加者、Hunter、籌碼、GPS、一番賞、二人影相、復活及事件紀錄
- 匯出紀錄：CSV 下載或複製文字紀錄
...
- Hunter 捉人會即時更新 `participant.status = "dead"`，並增加 Hunter `caughtCount`
